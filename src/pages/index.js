  ...
  return (
    <body>
      ...
      <p>
        ...
        continuing Full Stack Web Development education. If you're interested in
        connecting, please shoot me an{" "}
      ...
      <ul>
        <li>
          <code>Email: github.unlocking468@passmail.net</code>
        </li>
        <li>
          <code>
            LinkedIn: https://www.linkedin.com/in/henryhamiltonholmes/
          </code>
        </li>
      </ul>
    </body>
